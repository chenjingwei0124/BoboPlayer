...
@interface OnlyActivityViewController ()<UIWebViewDelegate>

@end

@implementation OnlyActivityViewController
...
-(void)setActivity:(OnlyActivity *)activity
{
    _activity = activity;
    self.webUrl = [activity.action objectForKey:@"value"];
}
/*
